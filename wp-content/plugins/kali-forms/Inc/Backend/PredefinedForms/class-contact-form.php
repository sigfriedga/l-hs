    ...
    public function __construct()
    {
        ...
        $this->emails      = [
            ...
            [
                ...
                "ccEmail"                  => "",
                "bccEmail"                 => "",
                "emailSubject"             => "Confirmación de contacto, en breve nuestro equipo contactará con usted",
                "emailAttachment"          => "",
                "emailAttachmentFilePaths" => "",
                "emailAttachmentMediaIds"  => "",
                "emailBody"                => "<p>Hello {first-name},</p> <p>Este es su correo electrónico de confirmación para <a href='{homeurl}'>{sitetitle}</a>.</p><p>Message:<br /> {message}</p><p>Gracias por contactar</p>",
            ],
        ];

        $this->form_info = [
            'thankYouMessage'     => '¡Gracias {first-name} por contactar con nosotros!',
        ...
        $this->field_components = [
            ["id" => "freeText", "label" => "Free Text", "internalId" => "freeText0", "properties" => ["id" => "greetings", "content" => "Utilice el formulario a continuación para ponerse en contacto con nuestro equipo."], "constraint" => 0],
